                                    ...
                                    if (!response.enable_notification) {
                                        ...
                                        chrome.storage.sync.get([`notification_enableAds`], (response) => {
                                            if (!response.notification_enableAds) {
                                                ...
                                                //PREMIUM AND PLUS
                                                $('.MainHeader').append(`<div id="notifyFixaPP"; class="col-sm-12"><div style="border-radius:5px; margin:5px; padding:5px; border: 1px solid #839800; background-color: rgba(7, 149, 66, 0.12156862745098039); box-shadow: 0px 0px 2px #259c08; color: white;"><i class="start-icon far fa-check-circle faa-tada animated"></i><strong class="font__weight-semibold"> LOBBY FIXADO!</strong> Chega de bugs na hora de desafiar outros times!</div></div>`);
                                                setTimeout(() => {
